...
export default function JournalEntryEditModal(props){
    const { modalShow, toggleModal, toggleEntryDeleteModal, 
            showGoBack, goBack,
            entryDto, setEntryDto, updateEntry,
            clearSelectedTransactionsFromTable } = props;
            ...
            <div className="modal__bottom-controls">
                ...
                <div className="modal__bottom-control-item">
                    <button
                        ...
                        onClick={() => {toggleEntryDeleteModal({entryId: entryDto.entryId, showGoBack: true})}}
                    >
                        Delete Entry
                    </button>
                </div>
