...
export default function JournalEntries(props) {
  ...
  const getSort = () => {
    return (prevEntryDto, currEntryDto) =>
      prevEntryDto[sortField] < currEntryDto[sortField]
        ? sortOrder
        : sortOrder * -1;
  };
  ...
  useEffect(() => {
    document.title = "Trade Journal - Entries";
  }, []);
  ...
  return (
    <>
      <div id="journal-sort">
        ...
        <div
          id="journal-sort__item--active-filter"
          className="journal-sort__item"
        >
          <input
            type="checkbox"
            value={true}
            onChange={handleActiveOnlyFilterChange}
          />
      ...
      <div id="journal">
        {Array.isArray(entriesWithTransactions) &&
          entriesWithTransactions
            .filter(getActiveOnlyFilter())
            .sort(getSort())
            .map((entryDto, entryDtoIdx) => (
              <div key={entryDtoIdx} className="entry entry--display">
                <div className="entry__header">
                  ...
                  <div className="entry--display__controls">
                    <button
                      ...
                      onClick={() => {
                        toggleEntryEditModal({ entryId: entryDto.entryId });
                      }}
                    >
                    ...
                    <button
                      ...
                      onClick={() => {
                        toggleEntryDeleteModal({ entryId: entryDto.entryId });
                      }}
                    >
                ...
                <div className="entry__description">{entryDto.description}</div>
